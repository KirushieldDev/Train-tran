...
export const TripSection: React.FC<TripSectionProps> = ({title, route, trips}) => {
    return (
        <section className="w-full max-md:max-w-full">
            <div className="flex flex-wrap mt-5 gap-10 justify-between items-center py-1 w-full max-md:max-w-full">
                ...
                <p className="self-stretch pb-2.5 my-auto text-sm text-textSecondary w-[105px]">{route}</p>
            </div>
