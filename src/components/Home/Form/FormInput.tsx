        ...
        <div className="flex flex-col grow shrink min-w-60 w-[323px]">
            ...
            <div className="flex relative justify-between items-start mt-2 w-full min-h-[55px]">
                <input
                    ...
                    className="z-0 flex-1 shrink self-stretch pl-12 my-auto text-base leading-6 text-gray-400 bg-white rounded-lg border border-gray-300 border-solid basis-0 min-w-60 w-[231px] min-h-[55px]"
                />
